...
class OrderStatusWidget extends StatelessWidget {
  ...
  final Map<String, int> allStatus = <String, int>{
    ...
    'refunded': 1, //Devolveu
    'paid': 2, //Pedido pago
    'preparing_purchase': 3, //Preparando o pedido
    'shipping': 4, //Pedido em transito
    'delivered': 5, //Entrega do pedido
  };
...
class _CustomDiviver extends StatelessWidget {
  const _CustomDiviver();
